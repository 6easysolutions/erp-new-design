...
import KopagPOS from "../feature-module/pos/KopagPOS";
import ItemMasterUpdatebyExcel from "../feature-module/setup/master/ItemMasterUpdatebyExcel";
import AllMasters from "../feature-module/setup/master/AllMaster";
import StockReasons from "../feature-module/setup/master/AllMaster/StockReasons";

import ItemName from "../feature-module/setup/master/AllMaster/ItemName";
import Brand from "../feature-module/setup/master/AllMaster/Brand";
import Size from "../feature-module/setup/master/AllMaster/Size";
import Colour from "../feature-module/setup/master/AllMaster/Colour";
import Category from "../feature-module/setup/master/AllMaster/Category";
import SubCategory from "../feature-module/setup/master/AllMaster/SubCategory";
import Style from "../feature-module/setup/master/AllMaster/Style";
import HsnSac from "../feature-module/setup/master/AllMaster/HsnSac";
import Racks from "../feature-module/setup/master/AllMaster/Racks";
import Itemtype from "../feature-module/setup/master/AllMaster/Itemtype";
import Gst from "../feature-module/setup/master/AllMaster/Gst";
import AddStore from "../feature-module/setup/configuration/AddStore";
import EditStore from "../feature-module/setup/configuration/EditStore";
import ViewStore from "../feature-module/setup/configuration/ViewStore";
import QuantityType from "../feature-module/setup/master/AllMaster/QuantityType";
import NewPurchase from "../feature-module/purchases/NewPurchase";
import PurchaseEdit from "../feature-module/purchases/PurchaseEdit";
import PurchaseReturnEdit from "../feature-module/purchases/PurchaseReturnEdit";
import ProductView from "../feature-module/inventory/ProductsAndServices/ProductView";
import AddProduct from "../feature-module/setup/master/AllMaster/AddProduct";
import EditProduct from "../feature-module/inventory/ProductsAndServices/ProductEdit";
import WriteOff from "../feature-module/inventory/WriteOff";
import InventoryCounts from "../feature-module/inventory/InventoryCounts/InventoryCounts";
import CountSessionsList from "../feature-module/inventory/InventoryCounts/CountSessionsList";
import CreateEditSession from "../feature-module/inventory/InventoryCounts/CreateEditSession";
import InternalOrders from "../feature-module/inventory/InternalOrders";
import Transfers from "../feature-module/inventory/Transfers";
import Stock from "../feature-module/inventory/Stock";
import StockMovement from "../feature-module/inventory/StockMovement";
import SalesMan from "../feature-module/setup/salesman/SalesMan";
import Sale from "../feature-module/sales/Sale";
import ActiveSession from "../feature-module/inventory/InventoryCounts/ActiveSession";
import PostedSessions from "../feature-module/inventory/InventoryCounts/PostedSessions";
import CreateInternalOrder from "../feature-module/inventory/InternalOrders/CreateInternalOrder";
import Warehouse from "../feature-module/setup/master/AllMaster/Warehouse";
import UnitOfMeasureTypes from "../feature-module/setup/master/AllMaster/UnitOfMeasureTypes";
import InternalOrder from "../feature-module/inventory/InternalOrders/InternalOrder";
import StockTransfers from "../feature-module/inventory/StockTransfers/StockTransfers";
import StockTransferList from "../feature-module/inventory/StockTransfers/StockTransfers";
import EditStockTransfer from "../feature-module/inventory/StockTransfers/EditTransfer";
import ViewStockTransfer from "../feature-module/inventory/StockTransfers/ViewTransfer";
import CreateStockTransfer from "../feature-module/inventory/StockTransfers/CreateTransfer";




const ProductList = lazy(
  () => import("../feature-module/inventory/ProductsAndServices/ProductsList")
);
...
const EditProducts = lazy(
  () => import("../feature-module/inventory/editproducts")
);
...
const StockAdjustment = lazy(
  () => import("../feature-module/inventory/StockAdjustment")
);
...
const Contacts = lazy(() => import("../feature-module/setup/master/AllMaster/contacts"));
...
const AccountSetting = lazy(() => import("../feature-module/setup/configuration/AccountSetting"));
const CustomerSetting = lazy(() => import("../feature-module/setup/configuration/CustomerSetting"));
const ItemMasterSettings = lazy(() => import("../feature-module/setup/configuration/ItemMasterSettings"));
const PurchaseSetting = lazy(() => import("../feature-module/setup/configuration/PurchaseSetting"));
const SaleSetting = lazy(() => import("../feature-module/setup/configuration/SaleSetting"));
const SaleSettingGST = lazy(() => import("../feature-module/setup/configuration/SaleSettingGST"));
const SearchSetting = lazy(() => import("../feature-module/setup/configuration/SearchSetting"));
const SupplierSetting = lazy(() => import("../feature-module/setup/configuration/SupplierSetting"));
const WhatsAppSetting = lazy(() => import("../feature-module/setup/configuration/WhatsAppSetting"));
const StoreSettings = lazy(() => import("../feature-module/setup/configuration/StoreSettings"));
...
const MyProfile = lazy(() =>
  import("../feature-module/Hrms/Profile/MyProfile")
);

const Departments = lazy(() =>
  import("../feature-module/Hrms/Hr/Masters/Departments")
);

const Designations = lazy(() =>
  import("../feature-module/Hrms/Hr/Masters/Designation")
);

const Organization = lazy(() =>
  import("../feature-module/Hrms/Hr/Masters/Organization")
);

const Employee = lazy(() =>
  import("../feature-module/Hrms/Hr/Masters/Employee")
);

const MyProfileSettings = lazy(() =>
  import("../feature-module/Hrms/HrmsProfile/MyProfileSettings")
);

const Team = lazy(() => import("../feature-module/Hrms/Hr/Masters/Team"));

//Hrms Leaves Modules
const ApplyforCompensatoryOff = lazy(() =>
  import("../feature-module/Hrms/Leaves/ApplyforCompensatoryOff")
);
const ApplyforLeave = lazy(() =>
  import("../feature-module/Hrms/Leaves/ApplyforLeave")
);
const ApplyforOptionalHolidays = lazy(() =>
  import("../feature-module/Hrms/Leaves/ApplyforOptionalHolidays")
);
const BalanceLog = lazy(() =>
  import("../feature-module/Hrms/Leaves/BalanceLog")
);
const HolidaysHistory = lazy(() =>
  import("../feature-module/Hrms/Leaves/HolidaysHistory")
);
const LeaveHistory = lazy(() =>
  import("../feature-module/Hrms/Leaves/LeaveHistory")
);
const LeavesRules = lazy(() =>
  import("../feature-module/Hrms/Leaves/LeavesRules")
);
const MyLeaveBalance = lazy(() =>
  import("../feature-module/Hrms/Leaves/MyLeaveBalance")
);

//Employee
const Attendance = lazy(() =>
  import("../feature-module/Hrms/Profile/Attendance")
);
const Requests = lazy(() => import("../feature-module/Hrms/Profile/Requests"));
const Onboarding = lazy(() =>
  import("../feature-module/Hrms/Profile/Onboarding")
);
const Salary = lazy(() =>
  import("../feature-module/Hrms/Profile/Salary")
);
const Clients = lazy(() => import("../feature-module/Hrms/Hr/Clients/Clients"));

const Projects = lazy(() =>
  import("../feature-module/Hrms/Hr/Clients/Projects")
);

const EditProfiledata = lazy(() =>
  import("../feature-module/Hrms/HrmsProfile/EditProfile")
);

const OrgChart = lazy(() =>
  import("../feature-module/Hrms/HrmsProfile/OrgChart")
);

//////////////////////////////Hrms-End/////////////////////////////////////

const PolicyNotice = lazy(() => import("../feature-module/pages/PolicyNotice"));
...
export const authRoutes = [
  ...
  {
    path: routes.allmasters,
    name: "allmasters",
    element: <AllMasters />,
    route: Route,
  },
  {
    path: routes.stockReasons,
    name: "stock-reasons",
    element: <StockReasons />,
    route: Route,
  },
  //Hrms-Start
  {
    id: 79,
    path: routes.Hrmsorgchart,
    name: "Orgchart",
    element: <OrgChart />,
    route: Route,
  },
  ...
  {
    id: 56,
    path: routes.HrmsMyProfileSettings,
    name: "employee",
  ...
  {
    id: 57,
    path: routes.HrmsApplyforCompensatoryOff,
    name: "leaves",
    element: <ApplyforCompensatoryOff />,
    route: Route,
  },
  {
    id: 58,
    path: routes.HrmsApplyforLeave,
    name: "leaves",
  ...
  {
    id: 59,
    path: routes.HrmsApplyforOptionalHolidays,
    name: "leaves",
    element: <ApplyforOptionalHolidays />,
    route: Route,
  },
  {
    id: 60,
    path: routes.HrmsBalanceLog,
    name: "leaves",
    element: <BalanceLog />,
    route: Route,
  },
  {
    id: 61,
    path: routes.HrmsHolidaysHistory,
    name: "leaves",
    element: <HolidaysHistory />,
    route: Route,
  },
  {
    id: 62,
    path: routes.HrmsLeaveHistory,
    name: "leaves",
  ...
  {
    id: 64,
    path: routes.HrmsMyLeaveBalance,
    name: "leaves",
    element: <MyLeaveBalance />,
    route: Route,
  },
  {
    id: 73,
    path: routes.HrmsEditProfiledata,
    name: "leaves",
  ...
  {
    id: 87,
    path: routes.salesettingsgst,
    name: "salesettingsgst",
    element: <SaleSettingGST />,
    route: Route
  },
  {
    id: 87,
    path: routes.purchasesettings,
    name: "purchasesettings",
    element: <PurchaseSetting />,
    route: Route
  },
  {
    id: 87,
    path: routes.itemmastersettings,
    name: "itemmastersettings",
    element: <ItemMasterSettings />,
    route: Route
  },
  {
    id: 87,
  ...
  {
    id: 87,
    path: routes.itemmasterupdatebyexcel,
    name: "itemmasterupdatebyexcel",
    element: <ItemMasterUpdatebyExcel />,
    route: Route
  },
  {
    id: 87,
  ...
  {
    id: 87,
    path: routes.purchasereturnedit,
  ...
  {
    id: 89,
    path: routes.inventorycounts,
    name: "inventorycounts",
    element: <InventoryCounts />,
    route: Route
  },
 
  {
    id: 89.2,
    path: "/inventory/count-sessions/create",
    name: "create-session",
    element: <CreateEditSession />,
    route: Route
  },
  {
    id: 89.21,
    path: "/inventory/count-sessions/edit/:id",
    name: "edit-session",
    element: <PostedSessions />,
    route: Route
  },
  {
    id: 89.3,
    path: "/inventory/count-sessions/active",
    name: "active-session",
  ...
  {
    id: 89.4,
    path: routes.inventorycountsedit,
    name: "posted-sessions",
    element: <PostedSessions />,
    route: Route
  },
  {
    id: 90,
    path: routes.internalorders,
    name: "internalorders",
  ...
  {
    id: 90,
    path: routes.createinternalorders,
    name: "createinternalorders",
    element: <CreateInternalOrder />,
    route: Route
  },
  {
    id: 90,
    path: routes.internalorder,
    name: "internalorder",
  ...
  {
    id: 114,
    path: routes.uomtypes,
    name: "uomtypes",
    element: <UnitOfMeasureTypes />,
    route: Route
  },
  {
    id: 115,
