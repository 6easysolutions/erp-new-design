                        ...
                        <div className="theme-layout mb-3">
                          ...
                          <label htmlFor="defaultLayout">
                            <span className="d-block mb-2 layout-img">
                              <img
                                src="src/assets/img/theme/default.svg"
                                alt="img"
                              />
                            </span>
                      ...
                      <div className="col-4">
                        <div className="theme-layout mb-3">
                          ...
                          <label htmlFor="miniLayout">
                            <span className="d-block mb-2 layout-img">
                              <img
                                src="src/assets/img/theme/mini.svg"
                                alt="img"
                              />
                            </span>
                      ...
                      <div className="col-4">
                        <div className="theme-layout mb-3">
                          ...
                          <label htmlFor="twocolumnLayout">
                            <span className="d-block mb-2 layout-img">
                              <img
                                src="src/assets/img/theme/two-column.svg"
                                alt="img"
                              />
                            </span>
                      ...
                      <div className="col-4">
                        <div className="theme-layout mb-3">
                          ...
                          <label htmlFor="horizontalLayout">
                            <span className="d-block mb-2 layout-img">
                              <img
                                src="src/assets/img/theme/horizontal.svg"
                                alt="img"
                              />
                            </span>
                      ...
                      <div className="col-4">
                        <div className="theme-layout mb-3">
                          ...
                          <label htmlFor="detachedLayout">
                            <span className="d-block mb-2 layout-img">
                              <img
                                src="src/assets/img/theme/detached.svg"
                                alt="img"
                              />
                            </span>
