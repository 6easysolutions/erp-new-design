...
const Team = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(URLS.AddHrmsTeam, formData, {
        headers: { Authorization: `Bearer ${token}` },
      });
                            ...
                            <div className="text-muted">
                              ...
                              {!searchTerm && departmentsData.length === 0 && (
                                <small className="text-muted">
                                  Click "Submit" to create your first Team
                                </small>
                              )}
                            </div>
                          </td>
