...
const AddStore = () => {
  ...
  const fetchServices = async () => {
    ...
    try {
      ...
      if (response.ok && data.success) {
        // Handle the response structure - services array
  ...
  const fetchStates = async () => {
    ...
    try {
      const response = await fetch(URLS.GetCountryByState, {
        ...
        body: JSON.stringify({ country_id: '5' }), // India as default
      });
      ...
      if (response.ok && data.success) {
        // Handle the response structure - states array
  ...
  const fetchCities = async (stateId) => {
    ...
    try {
      ...
      if (response.ok && data.success) {
        // Handle the response structure - cities array
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(URLS.AddStore, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
        },
